-- 016_platform_shared_chunks_ROLLBACK.sql
--
-- Reverts the three RPC functions back to their original signatures,
-- removing the optional p_platform_tenant_id parameter added in migration 016.
-- Run this in the Supabase SQL Editor if you want to fully undo migration 016.
--
-- Safe to run at any time — uses CREATE OR REPLACE, no downtime.
