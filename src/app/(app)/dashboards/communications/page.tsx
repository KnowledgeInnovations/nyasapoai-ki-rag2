...
export const metadata: Metadata = { title: 'Communications Dashboard - Nyansa AI' }
  ...
  return (
    <DashboardShell title="Communications Dashboard" description="Internal announcements, staff engagement, and communication effectiveness from your documents." lastUpdated={now}>
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        <StatCard icon={Radio}         label="Documents Indexed"   value={String(docCount ?? 0)}   sub="Workspace knowledge"           live color="text-gold-dark bg-gold-light" />
        ...
        <StatCard icon={Mail}          label="Key Announcements"   value="AI"                      sub="Analysed from documents"       live color="text-gold-dark bg-gold-light" />
