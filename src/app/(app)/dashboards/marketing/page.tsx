...
export const metadata: Metadata = { title: 'Marketing Dashboard - Nyansa AI' }
  ...
  return (
    <DashboardShell title="Marketing Dashboard" description="Campaign performance, lead generation, and marketing ROI from your documents." lastUpdated={now}>
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        <StatCard icon={Megaphone}     label="Documents Indexed"    value={String(docCount ?? 0)}   sub="Workspace knowledge"           live color="text-gold-dark bg-gold-light" />
