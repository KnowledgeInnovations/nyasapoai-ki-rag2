  ...
  return (
    <div className="animate-pulse space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[1, 2, 3, 4].map(i => (
          <div key={i} className="h-24 border border-gray-200 bg-gray-50" />
        ))}
      </div>
      ...
      <div className="space-y-3">
        {[1, 2, 3, 4, 5].map(i => (
          <div key={i} className="flex items-center gap-4 border border-gray-200 bg-white px-5 py-4">
            <div className="h-9 w-9 shrink-0 bg-gray-100" />
