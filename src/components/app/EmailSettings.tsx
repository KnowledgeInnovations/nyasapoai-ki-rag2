      ...
      <form onSubmit={handleSubmit} className="space-y-4 p-6">
        <div>
          ...
          <input type="email" value={email} disabled
            className="mt-1.5 w-full cursor-not-allowed  border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-400" />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="mt-1.5 w-full  border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-brand focus:ring-2 focus:ring-brand/10"
          />
        </div>
        ...
        {pending && (
          <div className="flex items-start gap-2  border border-emerald-200 bg-emerald-50 px-4 py-2.5 text-sm text-emerald-700">
