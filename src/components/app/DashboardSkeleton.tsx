    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-2">
          <div className="h-6 w-52 animate-pulse  bg-gray-200" />
          <div className="h-4 w-80 animate-pulse  bg-gray-100" />
        </div>
        <div className="h-7 w-36 animate-pulse  bg-gray-100" />
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {[0, 1, 2, 3].map(i => (
          <div key={i} className=" border border-gray-200 bg-white p-5 shadow-sm">
        ...
        {[0, 1, 2].map(i => (
          <div key={i} className=" border border-gray-200 bg-white p-5 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <div className="h-6 w-6 animate-pulse  bg-gray-100" />
            </div>
