    ...
    <>
      ...
      <div className="fixed bottom-0 right-0 z-50 flex flex-col bg-white shadow-2xl
          ...
          <div className="flex shrink-0 items-center gap-2">
            {data?.downloadUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-1.5  border border-gray-200 bg-white px-3 py-1.5 text-xs font-semibold text-gray-600 hover:bg-gray-50 hover:border-brand/30 hover:text-brand transition"
              >
            ...
            <button
              onClick={onClose}
              className="flex h-8 w-8 items-center justify-center  text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
        ...
        <div className="shrink-0 border-t border-gray-100 px-5 py-3 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className=" border border-gray-200 px-3 py-1.5 text-xs font-semibold text-gray-500 hover:bg-gray-50 transition"
          >
            Close
          </button>
        </div>
