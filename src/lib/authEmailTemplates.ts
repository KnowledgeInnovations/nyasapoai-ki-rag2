...
export function buildAuthEmail(actionType: string, vars: { confirmationURL?: string; token?: string }): BuiltEmail | null {
  ...
  switch (actionType) {
    case 'signup':
      return {
        subject: 'Confirm your NyasapoAI account',
        html: shell('', '', '', 'Confirm your email', ctaBody('Welcome to NyasapoAI. Click below to confirm your email address and finish setting up your account.', url, 'Confirm email'), EXPIRES_FOOTNOTE),
        text: `Confirm your email: ${url}`,
      }
    case 'invite':
      return {
        subject: "You've been invited to NyasapoAI",
        html: shell('', '', '', "You've been invited", ctaBody("You've been invited to join a workspace on NyasapoAI. Click below to accept the invitation and set up your account.", url, 'Accept invitation'), EXPIRES_FOOTNOTE),
        text: `Accept your invitation: ${url}`,
      }
    case 'magiclink':
      return {
        subject: 'Your NyasapoAI sign-in link',
        html: shell('', '', '', 'Sign in to NyasapoAI', ctaBody('Click below to securely sign in. No password needed.', url, 'Sign in'), EXPIRES_FOOTNOTE),
        text: `Sign in: ${url}`,
      }
    case 'recovery':
      return {
        subject: 'Reset your NyasapoAI password',
    ...
    case 'email_change_new':
      return {
        ...
        html: shell('', '', '', 'Confirm your new email', ctaBody('Click below to confirm this address as your new NyasapoAI account email.', url, 'Confirm new email'), EXPIRES_FOOTNOTE),
    ...
    case 'password_changed':
      return {
        ...
        html: shell('SECURITY ALERT', '#fff7ed', '#c2410c', 'Your password was changed', alertBody('The password for your NyasapoAI account was just changed.'), NOTIFICATION_FOOTNOTE),
        text: 'Your password was changed. If this wasn\'t you, contact your workspace admin immediately.',
      }
    case 'email_changed':
      return {
        subject: 'Your email address was changed',
        html: shell('SECURITY ALERT', '#fff7ed', '#c2410c', 'Your email address was changed', alertBody('The email address on your NyasapoAI account was just changed.'), NOTIFICATION_FOOTNOTE),
    ...
    case 'phone_changed':
      return {
        ...
        html: shell('SECURITY ALERT', '#fff7ed', '#c2410c', 'Your phone number was changed', alertBody('The phone number on your NyasapoAI account was just changed.'), NOTIFICATION_FOOTNOTE),
    ...
    case 'mfa_factor_enrolled':
      return {
        ...
        html: shell('SECURITY UPDATE', '#ecfdf5', '#047857', 'Two-factor authentication was enabled', alertBody('A new two-factor authentication method was just added to your NyasapoAI account, making it more secure.'), NOTIFICATION_FOOTNOTE),
    ...
    case 'mfa_factor_unenrolled':
      return {
        ...
        html: shell('SECURITY ALERT', '#fff7ed', '#c2410c', 'Two-factor authentication was disabled', alertBody('A two-factor authentication method was just removed from your NyasapoAI account.'), NOTIFICATION_FOOTNOTE),
    ...
    case 'identity_linked':
      return {
        ...
        html: shell('SECURITY ALERT', '#fff7ed', '#c2410c', 'A new sign-in method was added', alertBody('A new way to sign in was just linked to your NyasapoAI account.'), NOTIFICATION_FOOTNOTE),
    ...
    case 'identity_unlinked':
      return {
        ...
        html: shell('SECURITY ALERT', '#fff7ed', '#c2410c', 'A sign-in method was removed', alertBody('A sign-in method was just removed from your NyasapoAI account.'), NOTIFICATION_FOOTNOTE),
